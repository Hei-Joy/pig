...
public class CaseInfoServiceImpl extends ServiceImpl<CaseInfoMapper, CaseInfo> implements ICaseInfoService {
    ...
    public Page<CaseInfo> selectPageByKey(int page,int limit,String key,int userId, String bankname,String batchno,
        ...
        pages.setRecords(caseInfoMapper.selectPageByKey(current,limit,key, userId,bankname,batchno,ownerid,batchnoType,certno,sort,frontTime,rearTime,followSort));
