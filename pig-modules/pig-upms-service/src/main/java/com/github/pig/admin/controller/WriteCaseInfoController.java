...
public class WriteCaseInfoController {
    ...
    @GetMapping("/write")
    public void writeExcel1(HttpServletResponse response,String bankname,String name,String batchno,String ownerid,String batchnotype,String certno,String frontTime,String rearTime) throws Exception {
        String path="借款人员信息表";
        ...
        // 入参1: 创建要写入的模型数据
        // 入参2: 要写入的目标 sheet
        writer.write(writeeCaseInfoService.WriteQuery(bankname,name,batchno,ownerid,batchnotype,certno,frontTime,rearTime), sheet1);
