...
//    }
     ...
     */
    @RequestMapping("/page")
    public Page<CaseInfo> page(int page, int limit,String key,String bankname,String batchno,
                               String ownerid,String isMine,String batchnoType,String certno ,
                               String sort,String frontTime,String rearTime,String followSort){
        ...
        if(StringUtils.isBlank(key)){
            return caseInfoService.selectPageNoKey(page,limit,this.getUserId(),bankname,batchno,ownerid,batchnoType,certno,sort,frontTime,rearTime,followSort);
        }
        return  caseInfoService.selectPageByKey(page,limit,key,this.getUserId(),bankname,batchno,ownerid,batchnoType,certno,sort,frontTime,rearTime,followSort);
    }
