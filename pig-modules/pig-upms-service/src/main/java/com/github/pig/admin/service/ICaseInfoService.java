...
public interface ICaseInfoService extends IService<CaseInfo> {
    ...
    Page<CaseInfo> selectPageByKey(int page,int limit,String key,int userId,String bankname);

    Page<CaseInfo> selectPageByName(int page,int limit ,String name,int userId);

    Page<CaseInfo> selectPageNoKey(int page,int limit,int userId,String bankname);
}
