...
public interface ICaseInfoService extends IService<CaseInfo> {
    ...
    Page<CaseInfo> selectPageByKey(int page,int limit,String key,int userId,String bankname,String batchno,
    ...
    Page<CaseInfo> selectPageNoKey(int page,int limit,int userId,String bankname,String batchno,String ownerid,
